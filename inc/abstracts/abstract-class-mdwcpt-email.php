...
if ( ! class_exists( 'MDWCPT_Email' )  ) :

	/**
	 * Email class
	 */		
	abstract class MDWCPT_Email {
		...
		public function __construct( array $data ) {
			...
			if ( ! isset( $this->options ) || ! is_array( $this->options ) ) {
				...
				$this->options = MDWCPT_Utils::get_option( $option_key . '_email' );
			}
			
			$this->requested_price = is_numeric( $data['price'] ) ? (float) $data['price'] : null;
